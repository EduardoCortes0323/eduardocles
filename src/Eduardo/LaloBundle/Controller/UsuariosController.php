...
use Eduardo\LaloBundle\Entity\Usuarios;
...
class UsuariosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $usuarios = $em->getRepository('LaloBundle:Usuarios')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Eduardo\LaloBundle\Form\UsuariosType', $usuario);
    ...
    {
        $deleteForm = $this->createDeleteForm($usuario);
        $editForm = $this->createForm('Eduardo\LaloBundle\Form\UsuariosType', $usuario);
