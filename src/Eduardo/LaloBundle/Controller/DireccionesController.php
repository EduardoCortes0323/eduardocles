...
use Eduardo\LaloBundle\Entity\Direcciones;
...
class DireccionesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $direcciones = $em->getRepository('LaloBundle:Direcciones')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('Eduardo\LaloBundle\Form\DireccionesType', $direccione);
    ...
    {
        $deleteForm = $this->createDeleteForm($direccione);
        $editForm = $this->createForm('Eduardo\LaloBundle\Form\DireccionesType', $direccione);
